...
void loop()
{
    ...
    */
    ...
    if (E == black && F == white)
    {
        left_rotate(normal_speed/2, normal_speed/2);
    }
    else if (E == white && F == black)
    {
        right_rotate(normal_speed/2, normal_speed/2);
    }
    else if (B == black || C == black)
    {
    ...
    else if (A == white && B == white && C == white && D == white && E == white && F == white)
    {
        counter = 0;
        while (A == white && B == white && C == white && D == white && E == white && F == white)
        {
            counter = counter + 1;
            go_straight(gentle_speed, gentle_speed);
            update_ABCD();
    ...
    {
        //go_straight(normal_speed + 10, normal_speed);
        go_back(gentle_speed, gentle_speed);
    }
    //*/
}