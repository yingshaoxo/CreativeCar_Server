...
left_wheel = pyb.Pin("P0", pyb.Pin.OUT_PP)
right_wheel = pyb.Pin("P1", pyb.Pin.OUT_PP)
...
while(True):
    ...
    if deflection_angle > center_range_length:
        left_rotate()
        print("turn left")
    elif deflection_angle < -center_range_length:
        right_rotate()
        print("turn right")
    else:
        go_straight()
